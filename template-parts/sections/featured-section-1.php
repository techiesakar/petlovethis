...
<div class="relative">
    <!-- <div class="absolute top-0 left-0 right-0 h-1/2 bg-[#197667]  "></div> -->

    <div class="max-w-screen-xl mx-auto px-6">
        <div class="grid grid-cols-1 lg:grid-cols-2 lg:grid-rows-3 relative gap-4 mb-4">
            <?php
            $args = array(
                'post_type' => 'post',
                'posts_per_page' => 4,
            ...
            ?>
                    <?php if ($count == 1) : ?>
                        <!-- Card Start -->
                        <div class="card lg:row-span-3 col-span-1 relative rounded-lg overflow-hidden shadow-md hover:-translate-y-1 transition duration-300">
                            <a href="<?php the_permalink(); ?>" class="flex w-full h-full relative">
                                ...
                                <div class="card_body w-full p-6 absolute bottom-0 left-0 right-0">
                                    <div class="post-content rounded-lg bg-white p-5">
                                        <h2 class="mb-4 transition text-gray-900 hover:text-primary font-semibold text-xl"><?php the_title(); ?></h2>
                    ...
                    <?php else : ?>
                        <!-- Card Start -->
                        <div class="card lg:row-span-1 col-span-1 relative rounded-lg overflow-hidden shadow-md hover:-translate-y-1 transition duration-300">
                            <div class="flex w-full h-full relative  justify-between">
                                ...
                                <div class="w-[calc(100%-240px)] bg-white">
